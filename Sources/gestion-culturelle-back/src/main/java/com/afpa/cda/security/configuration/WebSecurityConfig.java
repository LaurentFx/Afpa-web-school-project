...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		String[] swaggerUrls = {"/v2/api-docs",
		...
		String[] respUrls = { "/animation/purpose","/manifestation/add","role/*","/salle/add",
				"/salle/update/*","/salle/delete/*","/typesalle/show/*","typesalle/add",
				"/typesalle/update/*","/typesalle/delete/*","/users/list","/users/show/*",
				"/users/add","/users/update/*","/users/delete/*"};

		String[] respAdminUrls = { "/animation/delete/*","/invitation/list","/invitation/update/*",
				"/manifestation/availability","/manifestation/update/","/manifestation/delete/*",
		"/salle/capacity/*"};

		String[] adminUrls = { "/vip","/invitation/manifestation/*","/invitation/add",
				"/invitation/delete/","/invitation/deleteAll/*","/users/invites/*"};

		String[] vipUrls = {"/invitation/show/*","/invitation/user/*","/invitation/new/*",
		"/invitation/reponse/*"} ;

		String[] animUrls = {"/animation/add","/animation/update/*"};

		String[] clientUrls = {"/article/*","/panier/*","/reservation/*"};
