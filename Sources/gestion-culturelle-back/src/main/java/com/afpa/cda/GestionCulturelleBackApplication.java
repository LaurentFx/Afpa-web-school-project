...
public class GestionCulturelleBackApplication  implements WebMvcConfigurer {
	...
	public CommandLineRunner init(RoleRepository roleRepository, UserRepository userRepository,
		...
		return (String... args)->{
			...
			User resp2 = new User(1,"resp2","resp2",password,mail,null,resp,adresse,entreprise);
			User admin1 = new User (2,"admin1","admin1",password,mail,null,admin,adresse,entreprise);
			User admin2 = new User (3,"admin2","admin2",password,mail,null,admin,adresse,entreprise);
			User anim1 = new User (4,"anim1","anim1",password,mail,null,anim,adresse,entreprise);
			User anim2 = new User (5,"anim2","anim2",password,mail,null,anim,adresse,entreprise);
			User anim3 = new User (6,"anim3","anim3",password,mail,null,anim,adresse,entreprise);
			User vip1 = new User (6,"vip1","vip1",password,mail,null,vip,adresse,entreprise);
			User vip2 = new User (6,"vip2","vip2",password,mail,null,vip,adresse,entreprise);
			User vip3 = new User (6,"vip3","vip3",password,mail,null,vip,adresse,entreprise);
			User vip4 = new User (6,"vip4","vip4",password,mail,null,vip,adresse,entreprise);
			User vip5 = new User (6,"vip5","vip5",password,mail,null,vip,adresse,entreprise);
			User vip6 = new User (6,"vip6","vip6",password,mail,null,vip,adresse,entreprise);
